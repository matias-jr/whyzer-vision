...
import { useHeroDemo, useMediaQuery } from '@/components/v8/hooks';
...
export default function FreeTrial() {
  ...
  // Same hero demo as /v8: types a company name, then cross-fades to the
  // research view. Falls back to the static end state under reduced motion.
