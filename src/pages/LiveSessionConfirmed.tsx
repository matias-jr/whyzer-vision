...
const LiveSessionConfirmed = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#FAFAF9' }}>
      {/* Post-registration page: its own canonical, and noindex so it stays out
          of search results and never stands in for the registration page. */}
      <Head>
        <title>You're Registered · Live Session | Whyzer</title>
