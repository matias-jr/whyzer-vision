      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-start">
          ...
          >
            ...
            <p className="text-[13px] text-text-secondary leading-relaxed mb-6">The full Whyzer platform: financial intelligence, executive profiles, Deal Maps, Account Audio Briefings, and AI-generated POVs across 8,500+ global companies. Show up prepared. Every time.</p>
